...
# open_project hls_isqrt_prj
# set_top top_process_magnitude
# add_files top_magnitude.cpp -cflags "-DSQRT_CORDIC -DONE_loop"
# add_files float_sqrt.cpp    -cflags "-DSQRT_CORDIC -DONE_loop"
# add_files cordic_sqrt.cpp   -cflags "-DSQRT_CORDIC -DONE_loop"
# add_files -tb test_main.cpp -cflags "-DSQRT_CORDIC -DONE_loop"
...
# open_solution "solution5_wordlength_optimized"
# set_part {xc7z020clg484-1}
# create_clock -period 10 -name default
# set_directive_inline "func2_process_magnitude"
# set_directive_inline "func1_process_magnitude"
